...
function handle_2(){
	var weatherSelect = document.getElementById('context-weather');
	...
	$( "#ui-species_d" ).on( "autocompleteselect", function(event, ui){
		document.getElementById('context-enemy-pokeType1').value = ui.item.pokeType1;
		document.getElementById('context-enemy-pokeType2').value = ui.item.pokeType2;
	...
	var enemyPokeType1Select = document.getElementById('context-enemy-pokeType1');
	var enemyPokeType2Select = document.getElementById('context-enemy-pokeType2');
...
function applyContext(){
	Context.weather = document.getElementById('context-weather').value;
	...
	Context.enemy.pokeType1 = document.getElementById('context-enemy-pokeType1').value;
	Context.enemy.pokeType2 = document.getElementById('context-enemy-pokeType2').value;
